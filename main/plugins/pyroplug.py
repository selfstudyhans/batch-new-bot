...
async def send_video_with_chat_id(client, sender, path, caption, duration, hi, wi, thumb_path, upm):
    ...
    try:
        await client.send_video(
            ...
            progress_args=(
                client,
                '**__Uploading: [Team Bhalu](https://t.me/owner_bhalu)__**\n ',
                upm,
                time.time()
            )
        )
...
async def send_document_with_chat_id(client, sender, path, caption, thumb_path, upm):
    ...
    try:
        await client.send_document(
            ...
            progress_args=(
                client,
                '**__Uploading:__**\n**__Bot made by [Team Bhalu](https://t.me/owner_bhalu)__**',
                upm,
                time.time()
            )
        )
        ...
        try:
           ...
           # medi =  msg.document or msg.video or msg.audio or None
            ...
            file = await userbot.download_media(
                ...
                progress_args=(
                    client,
                    "**__Unrestricting__: __[Team Bhalu](https://t.me/owner_bhalu)__**\n ",
                    edit,
                    time.time()
                )
            )  
